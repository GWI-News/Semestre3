  ...
  return (
    <>
      <div className={styles.container}>
        <h1>Conheça a Nossa Identidade, Equipe e Serviços!</h1>
        <p>Somos um portal de notícias regional comprometido em fornecer informações precisas, relevantes e atualizadas sobre os acontecimentos locais.
        ...
        <h2>Missão</h2>
        <p>Nosso objetivo na GWI News é fornecer informações precisas, imparciais e relevantes sobre os acontecimentos locais.
        ...
        <h2>Visão</h2>
        <p>Nossa visão na GWI News é ser o principal portal de notícias regional, reconhecido pela excelência na cobertura jornalística e pela relevância das histórias que contamos.
        ...
        <h2>Valores</h2>
        <p>GWI News valoriza a ética, a imparcialidade e a veracidade dos fatos. Nosso compromisso com a integridade jornalística é fundamental para fornecer informações confiáveis e construir a confiança de nossos leitores.
        ...
        <div className={styles.section}>
          ...
          <ul className={styles.equipeList}>
            <li>
              ...
              <p><strong>Carlos Ramos - Desenvolvedor</strong></p>
              <p>informações do carlos informações do carlos informações do carlos informações do carlos informações do carlos informações do carlos</p>
            </li>
            <li>
              <img src="gabriel.jpg" alt="Gabriel Fecchio" className={styles.image2} />
              <p><strong>Gabriel Fecchio - Desenvolvedor</strong></p>
              <p>informações do gabriel informações do gabriel informações do gabriel informações do gabriel informações do gabriel informações do gabriel</p>
            </li>
            <li>
              <img src="lucas.jpg" alt="Lucas Malachias" className={styles.image2} />
              <p><strong>Lucas Malachias - Desenvolvedor</strong></p>
              <p>informações do lucas informações do lucas informações do lucas informações do lucas informações do lucas informações do lucas</p>
            </li>
            <li>
              <img src="sophia.jpg" alt="Sophia Tavares" className={styles.image2} />
              <p><strong>Sophia Tavares - Desenvolvedora e Scrum Master</strong></p>
              <p>informações da sophia informações da sophia informações da sophia informações da sophia informações da sophia informações da sophia</p>
            </li>
          </ul>
        </div>
        ...
        <div className={styles.section}>
          <h2>Empregos</h2>
          <p>Descubra oportunidades profissionais com nosso serviço de divulgação de notícias de empregos.
        ...
        <div className={styles.section}>
          <h2>Educação</h2>
          <p>Esteja atualizado sobre as últimas tendências e novidades na área da educação, desde avanços na tecnologia educacional até políticas e programas educacionais inovadores.
        ...
        <div className={styles.section}>
          <h2>Esportes</h2>
          <p>Descubra o mundo emocionante do esporte com o nosso serviço de divulgação de notícias esportivas do Portal de Notícias!
        ...
        <div className={styles.section}>
          ...
          <p>Mantenha-se atualizado de lançamentos de filmes e séries a shows e concertos, trazemos informações exclusivas, entrevistas com artistas, críticas e recomendações para que você nunca perca os acontecimentos mais quentes do mundo do entretenimento.
        ...
        <div className={styles.section}>
          <h2>Economia</h2>
          <p>Nossa equipe de especialistas em economia traz análises aprofundadas, informações sobre empresas, relatórios de mercado e cobertura de eventos que afetam o cenário econômico.
