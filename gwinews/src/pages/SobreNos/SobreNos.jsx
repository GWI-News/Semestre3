  ...
  return (
    <div className={styles.container}>
      ...
      <ul>
        ...
        <li>Carlos Ramos - Desenvolvedor</li>
        ...
        <li>Gabriel Fecchio - Desenvolvedor</li>
        ...
        <li>Lucas Malachias - Desenvolvedor</li>
        ...
        <li>Sophia Tavares - Desenvolvedora e Scrum Master</li>
